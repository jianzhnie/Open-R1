...
def register_lighteval_task(
    ...
    task_list = ','.join(f'{eval_suite}|{task}|{num_fewshot}|0'
...
register_lighteval_task(LIGHTEVAL_TASKS, 'custom', 'aime25_part1',
                        'aime25:part1', 0)
...
def run_benchmark_jobs(training_args: Union['SFTConfig', 'GRPOConfig'],
