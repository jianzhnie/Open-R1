...
class GRPOConfig(TrainingArguments):
    ...
    remove_unused_columns: Optional[bool] = field(
        ...
        metadata={
            'help':
            "Whether to only keep the column 'prompt' in the dataset. If you use a custom reward function "
    ...
    num_generations: Optional[int] = field(
        ...
        metadata={
            'help':
            'Number of generations to sample. The global batch size (num_processes * per_device_batch_size) '
            'must be divisible by this value.'
        },
    )
    ...
    vllm_device: Optional[str] = field(
        ...
        metadata={
            'help':
            "Device where vLLM generation will run, e.g. 'cuda:1'. If set to 'auto' (default), the system "
    ...
    vllm_dtype: Optional[str] = field(
        ...
        metadata={
            'help':
            "Data type to use for vLLM generation. If set to 'auto', the data type will be automatically "
    ...
    vllm_enable_prefix_caching: Optional[bool] = field(
        ...
        metadata={
            'help':
            'Whether to enable prefix caching in vLLM. If set to `True` (default), ensure that the model and '
    ...
    ref_model_mixup_alpha: float = field(
        ...
        metadata={
            'help':
            'α parameter from the TR-DPO paper, which controls the mix between the current policy and the '
    ...
    ref_model_sync_steps: int = field(
        ...
        metadata={
            'help':
            'τ parameter from the TR-DPO paper, which determines how frequently the current policy is '
